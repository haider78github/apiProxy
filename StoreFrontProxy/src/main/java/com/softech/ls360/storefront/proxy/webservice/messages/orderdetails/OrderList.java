 ...
 *       &lt;sequence>
 *         &lt;element name="order" type="{http://www.example.org/OrderService}OrderDetailResponse" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    protected List<OrderDetailResponse> order;
     ...
     * {@link OrderDetailResponse }
     * 
     * 
     */
    public List<OrderDetailResponse> getOrder() {
        if (order == null) {
            order = new ArrayList<OrderDetailResponse>();
        }
        return this.order;
    }
