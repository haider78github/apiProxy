 ...
 */
@Configuration
@PropertySource(value = { "classpath:sf-webservice.properties" })
public class StorefrontWebServiceConfig {
	 ...
	 */
	@Bean
	public Jaxb2Marshaller orderDetailJax2bMarshaller() {
		 
		Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
		String[] packagesToScan = {"com.softech.ls360.storefront.proxy.webservice.messages.orderdetails"};
	  ...
	  */
	@Bean
	public WebServiceTemplate orderDetailWebServiceTemplate() {
		 
		WebServiceTemplate webServiceTemplate = new WebServiceTemplate();
		webServiceTemplate.setMessageFactory(soapMessageFactory());
		webServiceTemplate.setDefaultUri(env.getProperty("storefront.order.detail.uri"));
		webServiceTemplate.setMarshaller(orderDetailJax2bMarshaller());
		webServiceTemplate.setUnmarshaller(orderDetailJax2bMarshaller());
