...
public class RefundListTest extends StorefrontProxyAbstractTest {
	...
	public void refundListTest() {
		...
		OrderServiceResponseType orderServiceResponseType =  sfProxyOrderService.getRefundList(storeId, fromDate, toDate, status);
