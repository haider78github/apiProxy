...
import com.softech.ls360.web.proxy.config.annotation.RestEndpointAdvice;
import com.softech.ls360.web.proxy.config.spring.properties.WebProxyPropertiesConfig;
import com.softech.ls360.web.proxy.endpoint.restful.RestEndpointMarker;
import com.softech.ls360.web.proxy.exception.restful.RestExceptionMarker;
...
@Import({WebProxyPropertiesConfig.class})
public class RestServletContextConfiguration extends WebMvcConfigurerAdapter {
	...
	@Inject
	@Qualifier("webProxyJaxb2Marshaller")
