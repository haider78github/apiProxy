package com.softech.ls360.web.proxy.exception.restful;
...
public class RestExceptionHandler {
	...
	private static final String HTTP_STATUS_BAD_REQUEST = String.valueOf(HttpServletResponse.SC_BAD_REQUEST);
	private static final String HTTP_STATUS_INTERNAL_SERVER_ERROR = String.valueOf(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
